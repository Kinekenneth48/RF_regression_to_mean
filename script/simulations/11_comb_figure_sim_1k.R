...
# generation is at 1,000 observations for Gaussian and uniform data generation.
# This script is the follow-up of 00_simulation_gaussian_model_1k_linear.R and
